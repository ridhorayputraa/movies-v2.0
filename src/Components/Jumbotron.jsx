    ...
    <div className="card-wrapper-Jumbotron">
        <div className="Jumbotron-Card">
           <div className="Card-Text">
            <Typography sx={{color:'#f1efef', marginBottom:'0.4em'}}  variant='h4'>{movie.title}</Typography>  
            ...
            <Typography className="Text-TypoGrapghy" sx={{paddingTop:'0.9em'}}  variant='body1' >{movie.overview}</Typography>
             ...
             <Link className="Jumbotron-Card-Image"  to={`/detail/${movie.id}`}  >
            <img src={`${urlHeader}${movie.backdrop_path}`}   />
            </Link>
            </div>
